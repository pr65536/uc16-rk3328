...
$(UBOOT_BIN): $(UBOOT_SRC)
	...
	cd $(UBOOT_OUT) && ./tools/mkimage -n rk3328 -T rksd -d ../rk33-firmware/rk3328_ddr_786MHz_v1.06.bin idbloader.img
	cd $(UBOOT_OUT) && cat ../rk33-firmware/rk3328_miniloader_v2.43.bin >> idbloader.img
	cd $(UBOOT_OUT) && cp ../rk33-firmware/rk3328_loader_ddr786_v1.06.243.bin ${UBOOT_OUT}
